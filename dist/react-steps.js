...
function deepFreeze(obj) {
  if (obj !== undefined && (typeof obj === "undefined" ? "undefined" : _typeof(obj)) === "object" && obj !== null) {
...
var Arrows = function Arrows(_ref) {
  ...
  var renderStep = function renderStep(step, index) {
    ...
    return react.createElement(
      ...
      react.createElement(SvgArrow, { className: "Arrows--step--arrow" }),
      react.createElement(
        "div",
  ...
  if (!(model instanceof Steps)) {
    model = new Steps(model);
  }

  return react.createElement(
    "div",
    _extends({}, rest, { className: classnames("Arrows", className) }),
...
var SvgArrow = function SvgArrow(_ref2) {
  ...
  var gradientId = lodash_uniqueid("SvgArrow");
  return react.createElement(
    "svg",
    {
      width: "100%",
    ...
    react.createElement(
      ...
      react.createElement(
        ...
        react.createElement("stop", { offset: "0", stopColor: "#fff", stopOpacity: "0.10" }),
        react.createElement("stop", { offset: "1", stopColor: "#fff", stopOpacity: "0.25" })
      )
    ),
