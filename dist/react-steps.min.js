!(function(e, t) {
  ...
  var s = function() {};
  (s.thatReturns = l),
    (s.thatReturnsFalse = l(!1)),
    (s.thatReturnsTrue = l(!0)),
    (s.thatReturnsNull = l(null)),
  ...
  var f = s,
    ...
    v = p ? Symbol.for("react.return") : 60105,
    m = p ? Symbol.for("react.portal") : 60106,
    h = p ? Symbol.for("react.fragment") : 60107,
  ...
  (j.constructor = O), i(j, w.prototype), (j.isPureReactComponent = !0);
  ...
  function A(e, t, r) {
    ...
    if (null != t)
      ...
      t))
        P.call(t, n) && !N.hasOwnProperty(n) && (o[n] = t[n]);
    ...
    if (e && e.defaultProps)
      for (n in ((u = e.defaultProps), u)) void 0 === o[n] && (o[n] = u[n]);
    return {
      $$typeof: y,
      type: e,
      key: a,
  ...
  function F(e, t, r, n) {
    ...
    if (((a = 0), (t = "" === t ? "." : t + ":"), Array.isArray(e)))
      ...
      for (e = u.call(e), i = 0; !(o = e.next()).done; )
        (o = o.value), (u = t + I(o, i++)), (a += F(o, u, r, n));
    else
      "object" === o &&
        ((r = "" + e),
        g(
  ...
  var V = {
      Children: {
        ...
        forEach: function(e, t, r) {
          if (null == e) return e;
          (t = $(null, null, t, r)), null == e || F(e, "", D, t), U(t);
        },
        count: function(e) {
          return null == e ? 0 : F(e, "", f.thatReturnsNull, null);
        },
        toArray: function(e) {
          var t = [];
      ...
      cloneElement: function(e, t, r) {
        ...
        if (null != t) {
          if (
            (void 0 !== t.ref && ((a = t.ref), (u = R.current)),
          ...
          for (l in t)
            P.call(t, l) &&
              !N.hasOwnProperty(l) &&
              (n[l] = void 0 === t[l] && void 0 !== c ? c[l] : t[l]);
        }
  ...
  var B = function(e, t, r, n, o, a, i, u) {
      if ((Y(t), !e)) {
        var c;
        if (void 0 === t)
          c = new Error(
  ...
  var Z = function(e, t, r, n, o) {
        ...
        for (var a in e)
          if (e.hasOwnProperty(a)) {
            ...
            if (
              ...
              i instanceof Error && !(i.message in X))
            ) {
              X[i.message] = !0;
              var u = o ? o() : "";
              K(!1, "Failed %s type: %s%s", r, i.message, null != u ? u : "");
            }
          }
    },
    ee = r(function(e) {
      "production" !== process.env.NODE_ENV &&
        (function() {
          var t = i,
            ...
            v = l ? Symbol.for("react.fragment") : 60107,
          ...
          for (var E in j) j.hasOwnProperty(E) && S(E, j[E]);
          function R(e, t, n) {
            (this.props = e),
              (this.context = t),
              (this.refs = r),
          ...
          (N.constructor = R), t(N, k.prototype), (N.isPureReactComponent = !0);
          ...
          function L(e, t, r) {
            ...
            if (e && e.defaultProps) {
              ...
              for (n in _) void 0 === a[n] && (a[n] = _[n]);
            }
            if ((i || u) && (void 0 === a.$$typeof || a.$$typeof !== s)) {
              var w =
                "function" == typeof e
              ...
              i &&
                ...
                Object.defineProperty(d, "key", { get: m, configurable: !0 })),
                u &&
                  ((f = a),
                  (p = w),
                  ((y = function() {
          ...
          function te(e, t, r) {
            return null == e
              ...
              : (function e(t, r, a, i) {
                  ...
                  if (l) return a(i, t, "" === r ? M + re(t, 0) : r), 1;
                  var f = 0,
                    v = "" === r ? M : r + z;
                  if (Array.isArray(t))
                    for (var m = 0; m < t.length; m++)
                      f += e((c = t[m]), v + re(c, m), a, i);
                  else {
                    var h = b(t);
                    if ("function" == typeof h) {
                      h === t.entries &&
                        ...
                        (Y = !0));
                      for (var g, _ = h.call(t), w = 0; !(g = _.next()).done; )
                        f += e((c = g.value), v + re(c, w++), a, i);
                    } else if ("object" === u) {
                      var O;
                      O =
          ...
          function oe(e, t, r) {
            var n,
              ...
              c = e.func,
              l = e.context,
              s = c.call(l, t, e.count++);
            Array.isArray(s)
              ? ae(s, i, r, a.thatReturnsArgument)
              : null != s &&
                (V(s) &&
                  ((n = s),
                  (o =
                    u +
                    (!s.key || (t && t.key === s.key) ? "" : J(s.key) + "/") +
                    r),
                  (s = q(
                    n.type,
                    o,
          ...
          var ue = null,
            ...
            le = function() {
                    ...
                    null == (n = ue)
                      ...
                      : "string" == typeof n || "number" == typeof n
                        ...
                        : "string" == typeof n.type
                          ...
                          : n.type === v
                            ? "React.Fragment"
                            : n.type.displayName || n.type.name || "Unknown",
                  i = ue._owner;
                o += ((e = a),
                (t = ue._source),
                (r = i && ie(i)),
              ...
              return (o += W.getStackAddendum() || "");
            },
            se = new Map([["children", !0], ["key", !0]]);
          function fe() {
            if ($.current) {
              var e = ie($.current);
            ...
            if (e._store && !e._store.validated && null == e.key) {
              ...
              if (!pe[r]) {
                ...
                e &&
                  e._owner &&
                  e._owner !== $.current &&
                  (n = " It was passed a child from " + ie(e._owner) + "."),
                  (ue = e),
                  o(
                    !1,
          ...
          function ve(e) {
            ...
            if ("function" == typeof t) {
              var r = t.displayName || t.name,
                n = t.propTypes;
              n
                ? ((ue = e), u(n, e.props, "prop", r, le), (ue = null))
                : void 0 === t.PropTypes ||
                  ce ||
                  ((ce = !0),
                  o(
          ...
          function me(e, t, r) {
            ...
            if (null == u) return u;
            if (n)
              for (var c = 2; c < arguments.length; c++) de(arguments[c], e);
            return (
              "symbol" == typeof e && e === v
                ? (function(e) {
                    ue = e;
                    ...
                    try {
                      for (
                        var a, i = Object.keys(e.props)[Symbol.iterator]();
                        !(t = (a = i.next()).done);
                        t = !0
                      ) {
                        var u = a.value;
          ...
          var he = {
            Children: {
              map: function(e, t, r) {
                if (null == e) return e;
                var n = [];
                return ae(e, n, null, t, r), n;
              },
              forEach: function(e, t, r) {
                if (null == e) return e;
                var n = X(null, null, t, r);
                te(e, ne, n), ee(n);
              },
              count: function(e, t) {
                return te(e, a.thatReturnsNull, null);
              },
              toArray: function(e) {
                var t = [];
                return ae(e, t, null, a.thatReturnsArgument), t;
              },
              only: function(e) {
                return (
                  V(e) ||
            ...
            cloneElement: function(e, r, n) {
              for (
                var o = function(e, r, n) {
                    ...
                    return q(e.type, i, u, c, l, s, a);
                  }.apply(this, arguments),
                  a = 2;
                a < arguments.length;
                a++
              )
                de(arguments[a], o.type);
              return ve(o), o;
            },
            createFactory: function(e) {
          ...
          t(he.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, {
            ReactDebugCurrentFrame: W,
            ReactComponentTreeHook: {}
          });
          var be = Object.freeze({ default: he }),
            ge = (be && he) || be,
    ...
    re = r(function(e) {
      !(function() {
        ...
        e.exports ? (e.exports = r) : (window.classNames = r);
      })();
    }),
    ne = 1 / 0,
    oe = "[object Symbol]",
    ...
    ue = ae || ie || Function("return this")(),
    ce = 0,
    le = Object.prototype.toString,
    se = ue.Symbol,
    fe = se ? se.prototype : void 0,
    pe = fe ? fe.toString : void 0;
  function ye(e) {
    if ("string" == typeof e) return e;
    if (
      "symbol" == typeof (t = e) ||
      ((r = t) && "object" == typeof r && le.call(t) == oe)
    )
      return pe ? pe.call(e) : "";
    var t,
      r,
  ...
  (e.Arrows = function(e) {
    ...
    return te.createElement(
      "div",
      ve({}, u, { className: re("Arrows", r) }),
      t.steps.map(function(e, r) {
        var u = re(
          t.current === r && "Arrows--step__current",
          t.current > r && "Arrows--step__passed",
          t.current < r && "Arrows--step__coming"
        );
        return te.createElement(
          "div",
          { key: r, className: re("Arrows--step", u) },
          te.createElement(me, { className: "Arrows--step--arrow" }),
          te.createElement(
            "div",
            { className: "Arrows--step--content" },
            te.createElement(
              "span",
              { style: n, className: re("Arrows--step--number", o) },
              r + 1
            ),
            te.createElement(
              "span",
              { style: a, className: re("Arrows--step--label", i) },
              e.label
            )
          )
        );
